...
The CIViC project and ClinGen Somatic Cancer Biomedical Knowledgebase are currently supported by the National Institutes of Health (NIH) National Cancer Institute (NCI) under Award Numbers U24CA305456, U24CA275783, and R50CA305824, including a funding supplement from the NIH Office of Data Science Strategy (ODSS). CIViC is also supported by the Washington University Institute of Clinical and Translational Sciences grant UL1TR002345 from the National Center for Advancing Translational Sciences (NCATS) of the NIH. The content of this website is solely the responsibility of the creators and does not necessarily represent the official views of the NIH or other funding sources.
...
+---------------------------------------+---------------------------------------+
| **Source:** National Cancer Institute (NCI) Informatics Technology for        |
| Cancer Research (ITCR)                                                        |
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Early Stage Development Award for CIViC                                       |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| U01CA209936                           | 2016-2021                             |
+---------------------------------------+---------------------------------------+
...
| **Awardee:** Obi Griffith (Co-I Malachi Griffith)                             |
+---------------------------------------+---------------------------------------+
| **Source:** National Cancer Institute (NCI), Cancer Moonshot, Activities to   |
| Promote Technology Research Collaborations (APTRC) for Cancer Research        |
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Admin Suppl. Award to Support Development of CIViC-guided smMIPs Targeted     |
| Panel                                                                         |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| U01CA209936-S1                        | 2017-2021                             |
+---------------------------------------+---------------------------------------+
...
| **Awardee:** Obi Griffith (Co-I Malachi Griffith)                             |
+---------------------------------------+---------------------------------------+
| **Source:** NIH Cloud Credits Model Pilot of the NIH Big Data to Knowledge    |
| (BD2K) Program                                                                |
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Cloud Credits to Develop CIViC Cloud-Based Infrastructure                     |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| N/A                                   | 2017-2018                             |
+---------------------------------------+---------------------------------------+
...
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Funding to Support Integration with Google BigQuery                           |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| N/A                                   | 2019-2020                             |
+---------------------------------------+---------------------------------------+
...
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Advanced Stage Development Award for CIViC                                    |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| U24CA237719                           | 2019-2023                             |
+---------------------------------------+---------------------------------------+
...
| **Awardee:** Obi Griffith (Co-I Malachi Griffith)                             |
+---------------------------------------+---------------------------------------+
| **Source:** National Cancer Institute (NCI), Childhood Cancer Data Initiative |
| (CCDI)                                                                        |
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
...
+---------------------------------------+---------------------------------------+
| **Description:**                                                              |
| Genomic Curation Expert Panels Award to Support SC-VCEP Variation             |
+---------------------------------------+---------------------------------------+
| **Award Number:**                     | **Timeframe:**                        |
| U24CA258115                           | 2022-2025                             |
+---------------------------------------+---------------------------------------+
