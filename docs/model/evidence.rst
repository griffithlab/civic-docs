...
Evidence Items follow a structured knowledge model with required fields: Molecular Profile Name (Gene/Variant), Source, Variant Origin, Disease, Evidence Statement, Evidence Type, Evidence Level, Evidence Direction, Clinical Significance, and Trust Rating) with additional optional fields (Associated Phenotypes, etc). Based on the Evidence Type, additional required or optional fields become available (e.g., Predictive Evidence Types require a Therapy/Drug Name).
