...
Population frequencies should be based on current population databases (e.g., `gnomAD <https://gnomad.broadinstitute.org>`__) rather than the original report.
