...
The current Associated Phenotypes linked to Evidence Items and Assertions in CIViC can be explored on the `CIViC Phenotypes Page <https://civicdb.org/phenotypes/>`__.
