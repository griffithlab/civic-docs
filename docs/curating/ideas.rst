...
- Molecular Profiles (variants) and papers referenced in other open access databases such as `ClinVar <https://www.ncbi.nlm.nih.gov/clinvar/>`_ and `OMIM <https://www.ncbi.nlm.nih.gov/omim/>`_.
...
.. rubric:: 6. Molecular Profile Description
...
.. rubric:: 8. Bite-size curation tasks
